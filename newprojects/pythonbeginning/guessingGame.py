...
# create another varibale called out of guess...a boolean value so if its true the are out of guesses false equals no more chances  Set it as a False defaul
